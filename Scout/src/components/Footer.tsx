      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-4 mb-4 mb-md-0">
            ...
            <p className="small text-white-50">
              ...
              maç verilerini toplamak ve stratejik kararlar almak için
              geliştirilmiştir.
            </p>
            ...
            <ul className="list-unstyled">
              ...
              <li className="mb-2">
                <a
                  ...
                  className="text-white-50 text-decoration-none d-flex align-items-center"
                >
                  <i className="bi bi-chevron-right small me-2"></i> Takım
                  Hakkında
                </a>
              </li>
            </ul>
        ...
        <div className="row align-items-center">
          <div className="col-md-6 text-center text-md-start">
            ...
            >
              &copy; {new Date().getFullYear()} <strong>6038 ITOBOT</strong>.
          ...
          <div className="col-md-6 text-center text-md-end">
            <span className="small text-white-50">
              Developed by{" "}
              <span className="text-white fw-bold">ITOBOT Software Team</span>
            </span>
          </div>
        </div>
      </div>
